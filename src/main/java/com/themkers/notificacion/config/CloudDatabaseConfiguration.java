package com.themkers.notificacion.config;
...
@Configuration
@EnableMongoRepositories("com.themkers.notificacion.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.themkers.notificacion.config.dbmigrations");
